...
class PromptManager:
    ...
    def ops_prompt(self) -> str:
        ...
        return (
            ...
            "Core actions today include searching orders, reading customer 360s, summarizing sales, diagnosing payments, drafting shipping updates, creating or updating support tasks and internal notes, creating leads from conversations, reserving or releasing stock, updating order status, requesting cancellations, and sending WhatsApp or email messages only when explicitly asked. "
            "Use search_knowledge_base for policies or internal playbooks, not for live business state. "
            "Use search_visit_context for visits, events, slots, bookings, reservations, and hospitality availability. "
