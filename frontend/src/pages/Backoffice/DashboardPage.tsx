      ...
      <section className="rounded-lg border border-burgundy-100 bg-white p-5 shadow-[0_16px_48px_rgba(66,13,21,0.07)] md:p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="mt-1.5 text-2xl font-semibold text-burgundy-950">Dashboard</h1>
          </div>
          ...
          <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              >
                ...
                <p className="mt-3 text-4xl font-semibold text-burgundy-950">{card.value}</p>
              </article>
            ))}
          </section>

          <section className="grid gap-6 lg:grid-cols-[1fr_0.95fr]">
            <div className="rounded-lg border border-burgundy-100 bg-white p-6 shadow-[0_16px_48px_rgba(66,13,21,0.07)]">
              ...
              <div className="mt-5 space-y-4">
                {data.low_stock_items.length > 0 ? (
                  data.low_stock_items.map((item) => (
                    <div
                      key={item.id}
                      className="flex flex-col gap-2 rounded-lg border border-burgundy-100 bg-cream-50 px-4 py-4 md:flex-row md:items-center md:justify-between"
                    >
                      <div>
            ...
            <div className="rounded-lg border border-white/70 bg-burgundy-950 p-6 text-cream-50 shadow-[0_16px_48px_rgba(66,13,21,0.07)]">
