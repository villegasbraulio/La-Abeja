  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(200,169,110,0.12),transparent_28%),linear-gradient(180deg,#faf7f2,#f2e8da)] px-6 py-16">
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
        <div className="rounded-lg border border-white/70 bg-burgundy-950 p-8 text-cream-50 shadow-velvet md:p-10">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-gold-300">
            Panel interno
          </p>
          <h1 className="mt-4 font-serif text-4xl text-white">Backoffice Bodega La Abeja</h1>
          <p className="mt-5 max-w-xl leading-8 text-cream-100/80">
            Catálogo, precios, stock, pedidos, visitas y decisiones operativas en un mismo panel.
          </p>
        ...
        <div className="rounded-lg border border-burgundy-100 bg-white p-8 shadow-velvet md:p-10">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-burgundy-500">
            Iniciar sesión
          </p>
          <h2 className="mt-3 text-2xl font-semibold text-burgundy-950">Entrar al backoffice</h2>
